    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-lg font-bold mb-4">ShopVue</h3>
            <p className="text-gray-300 mb-4">
              Your one-stop shop for high-quality products at affordable prices.
              We bring you the best selection of items from around the world.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            &copy; {currentYear} ShopVue. All rights reserved.
          </p>
